...
Marking code blocks in markdown is easy as three crasis symbols. There isn’t much secret, just write the content, put the code around three crasis and let Agda do her work (yeah, I like to think Agda as *she*, [did you know she’s named after a hen?](https://www.youtube.com/watch?v=zPY42kkRADc)). Get the `AgdaMark.lagda.md` and compile using this command:
